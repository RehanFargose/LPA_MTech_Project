...
OUTPUT_DIR = f"My_Models/LegalBERT_Models/legalbert_fast_out_{start}-{end}_medium_1"
SEED = 42
...
MAX_WORDS = 150         # keep first ~350 words (~512 tokens or fewer)
MAX_LENGTH = 128        # tokenizer max tokens
BATCH_SIZE = 2          # try 4; reduce to 2 if OOM
